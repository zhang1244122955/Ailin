...
public class MessageUtils {
    ...
    // 配置您申请的KEY
    public static final String APPKEY = "b388faf494762c08118ce0aae068d32c";
    ...
    public static void send(String to, String code) {
        ...
        Map params = new HashMap();// 请求参数
        params.put("mobile", to);// 接收短信的手机号码
        params.put("tpl_id", "74257");// 短信模板ID，请参考个人中心短信模板设置
        params.put("tpl_value", "#code#=" + code + "&#m#=15");// 变量名和变量值对。如果你的变量名或者变量值中带有#&=中的任意一个特殊符号，请先分别进行urlencode编码后再传递，<a
