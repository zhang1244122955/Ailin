...
public class Image {
	...
	public Image(String image, String image_type) {
		super();
		this.image = image;
		this.image_type = image_type;
	}
	
	public Image(String image, String image_type, String face_type, String quality_control, String liveness_control) {
		super();
		this.image = image;
		this.image_type = image_type;
